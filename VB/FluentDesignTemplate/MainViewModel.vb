...
Namespace FluentDesignTemplate
    ...
    Public Class MainViewModel
        ...
        Public Sub New()
            AnalysisItems = New ObservableCollection(Of AnalysisItem)() From {New AnalysisItem() With {.Header = "Stock", .Text = "Market trends", .Image = GetImage("Stock.png")}, New AnalysisItem() With {.Header = "Metrics", .Text = "Key indicators", .Image = GetImage("Metrics.png")}, New AnalysisItem() With {.Header = "Competitors", .Text = "Growth rate, products, prices", .Image = GetImage("Competitors.png")}, New AnalysisItem() With {.Header = "Distribution", .Text = "Warehouse load, logistics", .Image = GetImage("Distribution.png")}, New AnalysisItem() With {.Header = "Feedback", .Text = "Requests, reviews, complaints", .Image = GetImage("Feedback.png")}}
